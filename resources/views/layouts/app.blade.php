        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link me-4 {{ Request::is('login') ? 'text-danger' : '' }}" href="{{ route('login') }}">Login</a>
                    <a class="nav-link me-4 {{ Request::is('register') ? 'text-danger' : '' }}" href="{{ route('register') }}">Register</a>
                </div>
            </div>
        </div>
    </nav>
